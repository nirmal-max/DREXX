...
if not exist "%ProgramFiles%\TortoiseSVN\bin\SubWCRev.exe" goto searchNativeProgramFiles
...
:searchNativeProgramFiles

if not exist "%ProgramW6432%\TortoiseSVN\bin\SubWCRev.exe" goto searchWoWProgramFiles
